...
import { Youtube, Facebook, Instagram, Twitter, MessageCircle, Book, FileText, Video, Monitor, Clipboard, Archive } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <nav style={{ backgroundColor: 'var(--charcoal)' }} className="h-[52px] sticky top-0 z-50 relative">
        ...
        <div className="flex items-center h-full pl-8 gap-8">
          {['ABOUT', 'REFEREES', 'BOOKS', 'VIDEOS', 'WEBINARS', 'COACHES', 'VAULT'].map((item) => (
            <a
              key={item}
              ...
              className={`text-[14px] uppercase relative pb-1 transition-colors ${hoveredNav === item ? 'text-[var(--orange)]' : 'text-white'
                }`}
            >
              {item}
              {hoveredNav === item && (
      ...
      "/>
        ...
        <div className="relative z-10 text-center px-4">
          <p style={{ fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: '4px', color: 'var(--orange)' }}
            className="text-[12px] uppercase mb-5">
      ...
      <section style={{ backgroundColor: 'var(--off-white)' }} className="relative">
      ...
      {/* FROM THE DESK */}
      <section style={{ backgroundColor: 'var(--pure-white)' }} className="relative pt-20 pb-20">
          ...
          <div className="grid grid-cols-3 gap-12 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2.5">
                {['About', 'Referees', 'Books', 'Videos', 'Webinars', 'Coaches', 'Vault'].map(link => (
                  <a
                    key={link}
            ...
            <div>
              ...
              <div className="bg-black border border-white/20 rounded-lg px-4 py-3 w-[180px] mb-3 cursor-pointer hover:border-[var(--orange)] transition-colors">
