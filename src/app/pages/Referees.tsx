...
const ASSIST_ARTICLES_DATA = [
  ...
  { id: 2, title: "SHOOTERS: MORE EFFICIENCY & LESS TURNOVERS", link: "https://www.refereevision.com/Referees/02_ref.pdf", articles: ["Three-point shooting drills", "Reducing turnovers under pressure", "Screening for shooters"] },
  { id: 3, title: "KENTUCKY MAN-TO-MAN OFFENSE", link: "https://www.refereevision.com/Referees/03_ref.pdf", articles: ["Kentucky Play '40' breakdown", "High-low offensive entry", "Creating mismatch opportunities"] },
  { id: 4, title: "AUSTRALIAN WORLD JUNIOR CHAMPION DEFENSE", link: "https://www.refereevision.com/Referees/04_ref.pdf", articles: ["Full court pressure defense", "Rotations on baseline drives", "Contesting the perimeter shooter"] },
  { id: 5, title: "THE GAME PHILOSOPHY OF THE SPURS", link: "https://www.refereevision.com/Referees/05_ref.pdf", articles: ["Gregg Popovich's offensive flow", "Ball movement & extra passes", "Pick & roll defense concepts"] },
  { id: 6, title: "ZONE DEFENSE CONCEPTS", link: "https://www.refereevision.com/Referees/06_ref.pdf", articles: ["Match-up zone strategies", "Defending the high post", "Box and one variations"] },
  { id: 7, title: "BASIC DEFENSE OF THE CROATIAN TEAM", link: "https://www.refereevision.com/Referees/07_ref.pdf", articles: ["Croatian national team defense", "Denying the wings", "Help and recover technique"] },
  { id: 8, title: "SAN ANTONIO SPURS OFFENSE", link: "https://www.refereevision.com/Referees/08_ref.pdf", articles: ["Motion offense systems", "Corner screen variations", "Spurs half-court sets"] },
  { id: 9, title: "FAST BREAK ATTACK SYSTEMS", link: "https://www.refereevision.com/Referees/09_ref.pdf", articles: ["Transition lane spacing", "Secondary break options", "Quick hitter plays"] },
  { id: 10, title: "DEFENSIVE ROTATIONS & HELPS", link: "https://www.refereevision.com/Referees/10_ref.pdf", articles: ["Strong-side help rules", "Recovering from traps", "Defending lob passes"] },
  { id: 11, title: "INDIVIDUAL OFFICIATING TECHNIQUES (IOT)", link: "https://www.refereevision.com/Referees/11_ref.pdf", articles: ["Referee court coverage", "Lead and trail responsibilities", "Correct angle of view"] },
  { id: 12, title: "WAKE FOREST OFFENSE", link: "https://www.refereevision.com/Referees/12_ref.pdf", articles: ["Flex offense variations", "High post feeding options", "Backdoor cut sets"] },
  { id: 13, title: "RETROGRADE DEFENSE SYSTEMS", link: "https://www.refereevision.com/Referees/13_ref.pdf", articles: ["Slowing down transition", "Guarding the outlet pass", "Defensive balance rules"] },
  { id: 14, title: "ZONE OFFENSE DRILLS & PLAYS", link: "https://www.refereevision.com/Referees/14_ref.pdf", articles: ["Breaking 2-3 zone defense", "High-low post execution", "Short corner passing"] },
  { id: 15, title: "3-PERSON MECHANICS ADVANCED", link: "https://www.refereevision.com/Referees/15_ref.pdf", articles: ["Rotations in 3PO", "Switching after fouls", "Coverage of the paint"] },
  { id: 16, title: "SAN ANTONIO SPURS DEFENSIVE SETS", link: "https://www.refereevision.com/Referees/16_ref.pdf", articles: ["Spurs pick & roll coverage", "Protecting the paint", "Communicating on screens"] },
  { id: 17, title: "OFFICIATING UNDER PRESSURE", link: "https://www.refereevision.com/Referees/17_ref.pdf", articles: ["Mental preparation tips", "Handling game tension", "Conflict resolution on court"] },
  { id: 18, title: "TRANSITION GAME SECRETS", link: "https://www.refereevision.com/Referees/18_ref.pdf", articles: ["Fast break execution", "Outlet pass accuracy", "Rim run optimization"] },
  { id: 19, title: "SCREENING COVERS & DEFENSE", link: "https://www.refereevision.com/Referees/19_ref.pdf", articles: ["Defending off-ball screens", "Switching vs. pushing through", "Hedge and recover drills"] },
  { id: 20, title: "FIBA OFFICIAL INTERPRETATIONS", link: "https://www.refereevision.com/Referees/20_ref.pdf", articles: ["Unsportsmanlike foul criteria", "Travel rule clarifications", "Cylinder principle guides"] },
  { id: 21, title: "WORLD GAME 2006: ONE GLOBE, ONE GOAL", link: "https://www.refereevision.com/Referees/21_ref.pdf", articles: ["Global basketball development", "Coaching education pathways", "Officiating standardizations"] },
  { id: 22, title: "INDIVIDUAL SKILL DEVELOPMENT", link: "https://www.refereevision.com/Referees/22_ref.pdf", articles: ["Ball handling fundamentals", "Footwork in the post", "Shooting off the dribble"] },
  { id: 23, title: "THE ART OF SCREENING", link: "https://www.refereevision.com/Referees/23_ref.pdf", articles: ["Setting legal block screens", "Pick and roll angles", "Down screen execution"] },
  { id: 24, title: "REBOUNDING PRINCIPLES", link: "https://www.refereevision.com/Referees/24_ref.pdf", articles: ["Box out techniques", "Offensive rebound positioning", "Transition off rebound"] },
  { id: 25, title: "RUSSIA'S TEAM DEFENSIVE PLAYS", link: "https://www.refereevision.com/Referees/25_ref.pdf", articles: ["Aggressive ball pressure", "Denial of passing lanes", "Russia's zone press"] },
  { id: 26, title: "OUT OF BOUNDS SETS (OB)", link: "https://www.refereevision.com/Referees/26_ref.pdf", articles: ["Baseline out of bounds plays", "Sideline out of bounds entries", "Last second shot setups"] },
  { id: 27, title: "TEX WINTER'S TRIANGLE OFFENSE", link: "https://www.refereevision.com/Referees/27_ref.pdf", articles: ["Triangle spacing positions", "Post feed options", "Blind pig entry cuts"] },
  { id: 28, title: "DEFENDING THE PICK & ROLL", link: "https://www.refereevision.com/Referees/28_ref.pdf", articles: ["Drop coverage execution", "Show and recover technique", "Blitzing the screen"] },
  { id: 29, title: "PHYSICAL TRAINING FOR OFFICIALS", link: "https://www.refereevision.com/Referees/29_ref.pdf", articles: ["Aerobic capacity building", "Agility and footwork drills", "Recovery between games"] },
  { id: 30, title: "YOUTH BASKETBALL PHILOSOPHY", link: "https://www.refereevision.com/Referees/30_ref.pdf", articles: ["Coaching mini-basketball", "Fundamental skill focus", "Keeping it fun for kids"] },
  { id: 31, title: "PRESSING DEFENSE SYSTEMS", link: "https://www.refereevision.com/Referees/31_ref.pdf", articles: ["1-2-1-1 full court press", "Trapping the corners", "Safety position rules"] },
  { id: 32, title: "REFEREE COMMUNICATION METHODS", link: "https://www.refereevision.com/Referees/32_ref.pdf", articles: ["Signal clarity & timing", "Pre-game referee meetings", "Interacting with coaches"] },
  { id: 34, title: "SPECIAL SITUATION PLAYS", link: "https://www.refereevision.com/Referees/34_ref.pdf", articles: ["Defending with seconds left", "Free throw rebound plays", "Jump ball scenarios"] },
  { id: 35, title: "DOUBLE TEAM TRAPPING SECRETS", link: "https://www.refereevision.com/Referees/35_ref.pdf", articles: ["Baseline trap rotation", "Wing trap containment", "Stealing the outlet pass"] },
  { id: 36, title: "BUILDING CHAMPIONSHIP CULTURE", link: "https://www.refereevision.com/Referees/36_ref.pdf", articles: ["Team chemistry exercises", "Leadership development", "Setting team standards"] },
  { id: 37, title: "DEFENDING THE INTERIOR PAINT", link: "https://www.refereevision.com/Referees/37_ref.pdf", articles: ["Post defense positioning", "Rotations from weak side", "Blocking out tall players"] },
  { id: 38, title: "YOUTH FITNESS & ATHLETICISM", link: "https://www.refereevision.com/Referees/38_ref.pdf", articles: ["Strength basics for youth", "Coordination exercises", "Injury prevention tips"] },
  { id: 39, title: "SHOOTING METRIC PERCENTAGES", link: "https://www.refereevision.com/Referees/39_ref.pdf", articles: ["Effective field goal rate", "Shot selection optimization", "Tracking shot analytics"] },
  { id: 40, title: "EUROPEAN ZONE OFFENSE", link: "https://www.refereevision.com/Referees/40_ref.pdf", articles: ["Continuous screening sets", "Ball reversal speed", "Attacking the seams"] },
  { id: 41, title: "MENTAL TOUGHNESS & PREPARATION", link: "https://www.refereevision.com/Referees/41_ref.pdf", articles: ["Visualisation before games", "Self-talk techniques", "Overcoming mistakes"] },
  { id: 42, title: "COOPERATION OF OFFICIALS", link: "https://www.refereevision.com/Referees/42_ref.pdf", articles: ["Eye contact on court", "Dual coverage decisions", "Correcting score mistakes"] },
  { id: 43, title: "BFI NATIONAL REFEREE SYSTEM", link: "https://www.refereevision.com/Referees/43_ref.pdf", articles: ["India licensing guidelines", "Fitness testing protocols", "BFI referee pathways"] },
  { id: 44, title: "PREPARATION FOR TOURNAMENTS", link: "https://www.refereevision.com/Referees/44_ref.pdf", articles: ["Nutrition prep for tournaments", "Scouting team plays", "Managing sleep schedule"] }
];
